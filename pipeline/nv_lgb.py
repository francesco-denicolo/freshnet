...
qd=dft.groupby(['sid','pid','day_idx'],sort=False)['pred'].sum().reset_index()
qd['tday']=qd.groupby(['sid','pid'],sort=False).cumcount()
qd=qd.rename(columns={'sid':'store_id','pid':'product_id','pred':'q'})[['store_id','product_id','tday','q']]
